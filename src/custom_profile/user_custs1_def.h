...
#define DEF_SVC2_UUID_128                   {0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x1a, 0x18, 0x00, 0x10}

#define DEF_SVC2_WRITE_VAL_1_UUID_128       {0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x58, 0x2a, 0x00, 0x10}
...
#define DEF_SVC2_WRITE_VAL_1_USER_DESC      "VOLTS"
// #define DEF_SVC2_WRITE_VAL_2_USER_DESC   "Write me (no rsp)"

// Battery service of the custom server 1
#define DEF_BATT_SVC_UUID_128               {0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x0f, 0x18, 0x00, 0x00}

#define DEF_BATT_SVC_READ_LVL_UUID_128      {0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x19, 0x2a, 0x00, 0x00}
#define DEF_BATT_SVC_READ_VOLTS_UUID_128    {0xfb, 0x34, 0x9b, 0x5f, 0x80, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x18, 0x2b, 0x00, 0x00}

#define DEF_BATT_SVC_READ_LVL_CHAR_LEN      1
#define DEF_BATT_SVC_READ_VOLTS_CHAR_LEN    2

#define DEF_BATT_SVC_READ_LVL_USER_DESC     "Battery percentage 0-100"
#define DEF_BATT_SVC_READ_VOLTS_USER_DESC   "Battery volts (in mV)"
...
enum
{
    ...
    BATT_SVC_READ_LVL_CHAR,
    BATT_SVC_READ_LVL_VAL,
    BATT_SVC_READ_LVL_USER_DESC,
    
    BATT_SVC_READ_VOLTS_CHAR,
    BATT_SVC_READ_VOLTS_VAL,
    BATT_SVC_READ_VOLTS_USER_DESC,
